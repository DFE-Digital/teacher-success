...
<%= render Cards::PromptComponent.new(
    ...
    <p class="govuk-body">
        Before you start your training, you could <a class="govuk-link" href="https://my.chartered.college/early-career-hub/lesson-planning/">read some lesson planning tips for trainees from the Chartered College of Teaching</a>.
    </p>
